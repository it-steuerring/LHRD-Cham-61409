...
param avdSessionHostCount int = 2 // Number of AVD session hosts to deploy. Change this value to fit your needs.
...
resource domainControllerConfiguration 'Microsoft.Compute/virtualMachines/extensions@2021-11-01' = {
  ...
  properties: {
    ...
    settings: {
      ModulesUrl: 'https://github.com/it-steuerring/LHRD-Cham-61409/raw/refs/heads/main/scripts/Deploy-DomainServices.zip'
